...
v4.3.0 — AAB-2026: FeatureEnvy, ShotgunSurgery, LSP (set_X side-effect), pre-commit hook (--min-score), code-analyze init. 48 critérios, 193 testes. Score AAB-2026: 96/100 (A).
